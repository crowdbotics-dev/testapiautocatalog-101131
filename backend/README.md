...
## Project Structure
    ...
    ├── testapiautocatalog_101131  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_101131`
...
2. Clone this repo and `cd testapiautocatalog_101131`
